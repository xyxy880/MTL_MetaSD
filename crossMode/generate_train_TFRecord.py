...
if __name__ == '__main__':
    ...
    for var in data:
        ...
        parser.add_argument('--labelpath', dest='labelpath', help='Path to HR images (./DIV2K_train_HR)',
                            default='/hdd/tianchuan/Meteorological_data/wrf_era5/era5/{}/HR_train/'.format(var))
        parser.add_argument('--tfrecord', dest='tfrecord', help='Save path for tfrecord file',
                            default='/hdd/tianchuan/Meteorological_data/wrf_era5/era5/{}/{}_train'.format(var,var))
