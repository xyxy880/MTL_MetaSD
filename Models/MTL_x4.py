...
class Weights(object):
    ...
    def build_CNN_params(self):
        ...
        with tf.variable_scope(self.scope):
            ...
            self.weights['conv3/w'] = tf.get_variable('conv3/kernel', [3, 3, 128, 48], initializer=kernel_initializer, dtype=tf.float32)
            self.weights['conv3/b'] = tf.get_variable('conv3/bias',[48], dtype=tf.float32, initializer=tf.zeros_initializer())
            ...
            self.weights['conv5/w'] = tf.get_variable('conv5/kernel', [3, 3, 128, 48], initializer=kernel_initializer, dtype=tf.float32)
            self.weights['conv5/b'] = tf.get_variable('conv5/bias',[48], dtype=tf.float32, initializer=tf.zeros_initializer())
            ...
            self.weights['conv7/w'] = tf.get_variable('conv7/kernel', [3, 3, 128, 48], initializer=kernel_initializer, dtype=tf.float32)
            self.weights['conv7/b'] = tf.get_variable('conv7/bias',[48], dtype=tf.float32, initializer=tf.zeros_initializer())
            ...
            self.weights['conv9/w'] = tf.get_variable('conv9/kernel', [3, 3, 128, 48], initializer=kernel_initializer,dtype=tf.float32)
            self.weights['conv9/b'] = tf.get_variable('conv9/bias', [48], dtype=tf.float32,initializer=tf.zeros_initializer())
...
class MODEL(object):
    ...
    def forward(self, x, param):
        ...
        with tf.variable_scope(self.name):
            ...
            self.conv4 = conv2d(self.deconv_1, param['conv4/w'], param['conv4/b'], scope='conv4',strides=4,activation='ReLU')
            ...
            self.conv6 = conv2d(self.conv5, param['conv6/w'], param['conv6/b'], scope='conv6',strides=4,activation='ReLU')
            ...
            self.conv8 = conv2d(self.conv7, param['conv8/w'], param['conv8/b'], scope='conv8',strides=4,activation='ReLU')
            ...
            self.output = conv2d(self.deconv_4, param['conv10/w'], param['conv10/b'], scope='conv10')
